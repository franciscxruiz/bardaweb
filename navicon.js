...
class Toggler {
  constructor(selector) {
    ...
    this.itemsCount = this.content.querySelectorAll(".menu> * ").length;
    this.counter = 0;
  ...
  bindEvents() {
    this.content.querySelectorAll(".menu a").forEach((item) => {
  ...
  toggleTo(index) {
    this.content
      .querySelector(".menu a:nth-child(" + (index + 1) + ")")
      .classList.toggle("open");
  }
}

(function () {
  new Toggler(".navegacion");
})();
